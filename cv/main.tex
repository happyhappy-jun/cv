...
\resumeItem{Improved the legacy MCMC-based Life Time Value Model.}
\resumeItem{Implemented and maintained a PPO-based puzzle game automation agent.}
...
\resumeItemListStart
\resumeItem{Researched unsupervised clustering of Webtoon drawing styles related to deformation to provide classification of art styles for ML tasks.}
\resumeItem{Investigated Webtoon drawing style embedding model and similarity metrics based on a metric learning.}
\resumeItemListEnd
...
\resumeItem{Researching ML pipeline of automatic CWE patch (including vulnerability detection, patch generation)}
\resumeItemListEnd
