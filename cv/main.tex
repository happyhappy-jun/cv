...
\begin{center}
  ...
  $|$
  \faAt \hspace{.5pt} \href{mailto:bjyoon513@gmail.com}{bjyoon513@gmail.com}
  $|$
...
\resumeItem{My research interest lies in various topics in \textbf{Machine Learning}, \textbf{Large Language Models}, and \textbf{their practical applications}. I am particularly interested in ML/AI topics that can enhance human productivity. Currently, the large language model and its factual content generation are my main focuses.}
...
{B.S. in Computer Science}{Feb 2019 \textbf{--} Present}
...
\resumeItemListStart
\resumeItem{Led the development of a Customer ROAS Prediction System using Deep Learning for data-oriented UA marketing decisions.}
\resumeItem{Improved the legacy MCMC-based Life Time Value Model.}
\resumeItem{Implemented and managed a PPO-based puzzle game automation AI.}
\resumeItem{Developed a log-based user churn prediction algorithm for Cookie Run: Kingdom.}
...
\resumeItem{Investigated Webtoon drawing style embedding algorithms and similarity metrics based on metric learning.}
\resumeItemListEnd
