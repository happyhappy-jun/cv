...
{B.S. in Computer Science (GPA: 3.6, Major GPA: 3.8)}{Feb 2019 \textbf{--} Present}
{Including 2 year military service}
...
\resumeSubHeadingListStart
\resumeSubheading
{Finding the optimal dynamic granularity for RAG framework}
{DI Lab}
{Advisor: \href{https://sites.google.com/view/postechdi/member/faculty}{Hwanjo Yu}}
{Feb 2024 \textbf{--} Present, Internship}
\resumeItemListStart
\resumeItem{Researching a new RAG framework to improve retrieval granularity in RAG framework by end-to-end training of 'segmentor'}
\resumeItemListEnd
...
{DI Lab}
{Advisor: \href{https://sites.google.com/view/postechdi/member/faculty}{Hwanjo Yu}}
{Sep 2023 \textbf{--} Jan 2024, Internship}
\resumeItemListStart
